...
describe("Post Component Testing", () => {
  ...
  describe("Method tests", () => {
    test("formatDate", () => {
      const formatDate = wrapper.instance().formatDate;
    ...
    test("trimContent", () => {
      const trimContent = wrapper.instance().trimContent;
  ...
  describe("Element render tests", () => {
    ...
    test("Text store match", () => {
      ...
      expect(wrapper.find(CardContent).text()).toBe(wrapper.instance().trimContent(post.description));
    });
  });
